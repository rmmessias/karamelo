...
void DumpGrid::write() {
  ...
  th->first = thread(&DumpGrid::write_to_file, this, ithread, fdump, total_nn, update->ntimestep);
}

void DumpGrid::write_to_file(bigint i, string fdump, bigint total_nn, bigint timestep) {
  // Open the file fdump:
  ofstream dumpstream(fdump.c_str());
